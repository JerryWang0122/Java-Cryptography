...
public class TOTP {
    public static void main(String[] args) throws NoSuchAlgorithmException, InvalidKeyException {
        String source = Base64.getEncoder().encodeToString("MyKey".getBytes());  // 當作金鑰
        long timeInterval = System.currentTimeMillis() / 1000L / 30L;  // 30 秒
        // 使用 HMACSHA256 為加密算法
        String totp = KeyUtil.generateTOTP(source, timeInterval, "HMACSHA256");
        System.out.printf("我的TOTP密碼：%s%n", totp);
    }
}
